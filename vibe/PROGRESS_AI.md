...
### 4.1 Prompt 模板
- [x] 创建 `src/lib/ai/prompts/modify.ts`（整合润色/扩写/缩写）
- [x] 实现润色 System Prompt
- [x] 实现扩写 System Prompt
- [x] 实现缩写 System Prompt
- [x] 实现 JSON 结构化输出解析
- [x] 实现项目信息注入到 System Prompt
...
### 4.3 结果卡片
- [x] 创建 `src/components/ai/ai-result-card.tsx`
- [x] 实现原文 vs 修改后对比显示
- [x] 实现"应用"按钮（触发全局事件）
- [x] 实现"复制"按钮
- [x] 实现"删除"按钮
...
### 4.4 上下文构建器
- [x] 创建 `src/lib/ai/context-builder.ts`
- [x] 实现 NodeContext 构建
- [x] 实现 EntityContext 构建
- [x] 实现 SelectionContext 构建
- [x] 实现上下文合并与去重
- [x] 实现 Token 估算与截断

### 4.5 功能集成
- [x] 更新 API 路由支持修改功能
- [x] 更新 AI Store 支持修改结果状态
- [x] 更新聊天输入组件支持修改功能
- [x] 更新消息列表组件显示结果卡片
- [x] 实现编辑器监听应用修改事件
- [x] 测试修改功能
...
#### 5.1.1 Prompt 模板
- [x] 创建 `src/lib/ai/prompts/plan.ts`
- [x] 实现规划 System Prompt
- [x] 实现 JSON 结构化输出解析

#### 5.1.2 上下文构建
- [x] 创建 `src/lib/ai/context-builder.ts` 中的 `buildPlanContext`
- [x] 实现当前节点信息提取（名称、大纲）
- [x] 实现已有子节点信息提取（名称、摘要）
- [x] 实现父节点信息提取（上下文增强）
- [x] 实现关联实体提取
...
#### 5.1.3 功能处理器
- [x] 创建 `src/lib/ai/handlers/plan.ts`
- [x] 实现消息构建逻辑
- [x] 实现响应解析逻辑

#### 5.1.4 UI 组件
- [x] 更新功能选择器（隐藏规划/续写/总结入口）
- [x] 创建规划结果卡片组件 `ai-plan-result-card.tsx`
- [x] 在文件夹编辑器添加 AI 规划按钮
- [x] 实现规划触发逻辑（打开浮窗、设置功能、添加上下文）
...
│   │   ├── modify.ts              ← Phase 4.1 ✅（整合润色/扩写/缩写）
...
| 2026-01-05 | 完成 Phase 4.1: 修改功能 Prompt 模板 |
| 2026-01-05 | 完成 Phase 4.3: 结果卡片组件 |
| 2026-01-05 | 完成 Phase 4.4: 上下文构建器 |
| 2026-01-05 | 更新 API 路由和 AI Store 支持修改功能 |
| 2026-01-06 | 完成 Phase 5.1: 规划功能（Prompt、上下文构建、UI、应用逻辑） |

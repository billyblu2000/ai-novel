...
### 2.1 设置存储
- [ ] 创建 `src/lib/ai/settings.ts`
- [ ] 实现 localStorage 读写
- [ ] 实现 API Key 加密/解密（AES）
- [ ] 实现设置默认值

### 2.2 AI Store (Zustand)
- [ ] 创建 `src/lib/stores/ai-store.ts`
- [ ] 管理当前 AI 状态（loading, streaming, error）
- [ ] 管理聊天历史
- [ ] 管理上下文列表
- [ ] 管理破限模式状态

### 2.3 设置弹窗组件
- [ ] 创建 `src/components/ai/ai-settings-dialog.tsx`
- [ ] 实现 Provider 列表 UI
- [ ] 实现 API Key 输入 + 测试连接
- [ ] 实现功能模型配置 UI
- [ ] 实现自定义 Prompt 编辑器
